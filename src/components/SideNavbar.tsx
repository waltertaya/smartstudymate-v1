...
export function SideNavbar() {
  return (
    <nav className="flex flex-col grow py-5 w-full text-base text-center text-black rounded-lg bg-zinc-300 max-md:mt-6">
      <h2 className="self-center">Add new documents</h2>
      <div className="flex flex-col items-start px-3.5 mt-4 w-full">
        <UploadArea />
        <FileList />
        <QuickLinks />
...
function QuickLinks() {
  return (
    <div className="flex gap-2.5 mt-48 max-md:mt-10 max-md:ml-1">
      <nav className="self-end mt-44 whitespace-nowrap max-md:mt-10">
        <div className="flex gap-3 max-md:mr-1">
          <img
            ...
            alt="Quizes icon"
          />
          <span className="my-auto">Quizes</span>
        </div>
